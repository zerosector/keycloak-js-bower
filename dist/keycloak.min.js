(function(k,I){var x=function(l){function p(){return"undefined"!==typeof b.authServerUrl?"/"==b.authServerUrl.charAt(b.authServerUrl.length-1)?b.authServerUrl+"realms/"+encodeURIComponent(b.realm):b.authServerUrl+"/realms/"+encodeURIComponent(b.realm):I}function B(a,c){function e(e,d,f,g){q=(q+(new Date).getTime())/2;w(e,d,f,q);C&&(b.tokenParsed&&b.tokenParsed.nonce!=a.storedNonce||b.refreshTokenParsed&&b.refreshTokenParsed.nonce!=a.storedNonce||b.idTokenParsed&&b.idTokenParsed.nonce!=a.storedNonce)?
(console.info("[KEYCLOAK] Invalid nonce, clearing token"),b.clearToken(),c&&c.setError()):g&&(b.onAuthSuccess&&b.onAuthSuccess(),c&&c.setSuccess())}var d=a.code,f=a.error,g=a.prompt,q=(new Date).getTime();if(f)"none"!=g?(d={error:f,error_description:a.error_description},b.onAuthError&&b.onAuthError(d),c&&c.setError(d)):c&&c.setSuccess();else if("standard"!=b.flow&&(a.access_token||a.id_token)&&e(a.access_token,null,a.id_token,!0),"implicit"!=b.flow&&d){var d="code\x3d"+d+"\x26grant_type\x3dauthorization_code",
...
a=b.createLoginUrl(a);var g=c(a,"_blank",e),q=!1;g.addEventListener("loadstart",function(a){0==a.url.indexOf("http://localhost")&&(a=E(a.url),B(a,d),g.close(),q=!0)});g.addEventListener("loaderror",function(a){q||(0==a.url.indexOf("http://localhost")?(a=E(a.url),B(a,d),g.close(),q=!0):(d.setError(),g.close()))});return d.promise},logout:function(a){var d=m();a=b.createLogoutUrl(a);var e=c(a,"_blank","location\x3dno,hidden\x3dyes"),g;e.addEventListener("loadstart",function(a){0==a.url.indexOf("http://localhost")&&
e.close()});e.addEventListener("loaderror",function(a){0!=a.url.indexOf("http://localhost")&&(g=!0);e.close()});e.addEventListener("exit",function(a){g?d.setError():(b.clearToken(),d.setSuccess())});return d.promise},register:function(){var a=b.createRegisterUrl(),d=c(a,"_blank","location\x3dno");d.addEventListener("loadstart",function(a){0==a.url.indexOf("http://localhost")&&d.close()})},accountManagement:function(){var a=b.createAccountUrl();if("undefined"!==typeof a){var d=c(a,"_blank","location\x3dno");
...
new G;break a}catch(g){}y=new H}r=a&&"cordova"===a.adapter?A("cordova"):a&&"default"===a.adapter?A():k.Cordova||k.cordova?A("cordova"):A();if(a){"undefined"!==typeof a.useNonce&&(C=a.useNonce);"undefined"!==typeof a.checkLoginIframe&&(h.enable=a.checkLoginIframe);a.checkLoginIframeInterval&&(h.interval=a.checkLoginIframeInterval);"login-required"===a.onLoad&&(b.loginRequired=!0);if(a.responseMode)if("query"===a.responseMode||"fragment"===a.responseMode)b.responseMode=a.responseMode;else throw"Invalid value for responseMode";
if(a.flow){switch(a.flow){case "standard":b.responseType="code";break;case "implicit":b.responseType="id_token token";break;case "hybrid":b.responseType="code id_token token";break;default:throw"Invalid value for flow";}b.flow=a.flow}null!=a.timeSkew&&(b.timeSkew=a.timeSkew)}b.responseMode||(b.responseMode="fragment");b.responseType||(b.responseType="code",b.flow="standard");var e=m(),d=m();d.promise.success(function(){b.onReady&&b.onReady(b.authenticated);e.setSuccess(b.authenticated)}).error(function(a){e.setError(a)});
var f=L(l);f.success(function(){var e=E(k.location.href);e&&k.history.replaceState({},null,e.newUrl);if(e&&e.valid)return F().success(function(){B(e,d)}).error(function(a){d.setError()});a?a.token&&a.refreshToken?(w(a.token,a.refreshToken,a.idToken),h.enable?F().success(function(){z().success(function(){b.onAuthSuccess&&b.onAuthSuccess();d.setSuccess()}).error(function(){w(null,null,null);d.setSuccess()})}):b.updateToken(-1).success(function(){b.onAuthSuccess&&b.onAuthSuccess();d.setSuccess()}).error(function(){b.onAuthError&&
b.onAuthError();a.onLoad?c():d.setError()})):a.onLoad?c():d.setSuccess():d.setSuccess()});f.error(function(){e.setError()});return e.promise};b.login=function(a){return r.login(a)};b.createLoginUrl=function(a){var c=J(),e=J(),d=r.redirectUri(a),f={state:c,nonce:e,redirectUri:encodeURIComponent(d)};a&&a.prompt&&(f.prompt=a.prompt);y.add(f);var f=a&&"register"==a.action?b.endpoints.register():b.endpoints.authorize(),g=a&&a.scope?"openid "+a.scope:"openid",c=f+"?client_id\x3d"+encodeURIComponent(b.clientId)+
"\x26redirect_uri\x3d"+encodeURIComponent(d)+"\x26state\x3d"+encodeURIComponent(c)+"\x26response_mode\x3d"+encodeURIComponent(b.responseMode)+"\x26response_type\x3d"+encodeURIComponent(b.responseType)+"\x26scope\x3d"+encodeURIComponent(g);C&&(c=c+"\x26nonce\x3d"+encodeURIComponent(e));a&&a.prompt&&(c+="\x26prompt\x3d"+encodeURIComponent(a.prompt));a&&a.maxAge&&(c+="\x26max_age\x3d"+encodeURIComponent(a.maxAge));a&&a.loginHint&&(c+="\x26login_hint\x3d"+encodeURIComponent(a.loginHint));a&&a.idpHint&&
(c+="\x26kc_idp_hint\x3d"+encodeURIComponent(a.idpHint));a&&a.locale&&(c+="\x26ui_locales\x3d"+encodeURIComponent(a.locale));return c};b.logout=function(a){return r.logout(a)};b.createLogoutUrl=function(a){return b.endpoints.logout()+"?redirect_uri\x3d"+encodeURIComponent(r.redirectUri(a,!1))};b.register=function(a){return r.register(a)};b.createRegisterUrl=function(a){a||(a={});a.action="register";return b.createLoginUrl(a)};b.createAccountUrl=function(a){var c=p(),e=I;"undefined"!==typeof c&&(e=
...
c.promise;a=a||5;var e=function(){var d=!1;if(-1==a)d=!0,console.info("[KEYCLOAK] Refreshing token: forced refresh");else if(!b.tokenParsed||b.isTokenExpired(a))d=!0,console.info("[KEYCLOAK] Refreshing token: token expired");if(d){var d="grant_type\x3drefresh_token\x26refresh_token\x3d"+b.refreshToken,e=b.endpoints.token();u.push(c);if(1==u.length){var g=new XMLHttpRequest;g.open("POST",e,!0);g.setRequestHeader("Content-type","application/x-www-form-urlencoded");g.withCredentials=!0;b.clientId&&b.clientSecret?
g.setRequestHeader("Authorization","Basic "+btoa(b.clientId+":"+b.clientSecret)):d+="\x26client_id\x3d"+encodeURIComponent(b.clientId);var h=(new Date).getTime();g.onreadystatechange=function(){if(4==g.readyState)if(200==g.status){console.info("[KEYCLOAK] Token refreshed");h=(h+(new Date).getTime())/2;var a=JSON.parse(g.responseText);w(a.access_token,a.refresh_token,a.id_token,h);b.onAuthRefreshSuccess&&b.onAuthRefreshSuccess();for(a=u.pop();null!=a;a=u.pop())a.setSuccess(!0)}else for(console.warn("[KEYCLOAK] Failed to refresh token"),
b.onAuthRefreshError&&b.onAuthRefreshError(),a=u.pop();null!=a;a=u.pop())a.setError(!0)};g.send(d)}}else c.setSuccess(!1)};h.enable?z().success(function(){e()}).error(function(){c.setError()}):e();return c.promise};b.clearToken=function(){b.token&&(w(null,null,null),b.onAuthLogout&&b.onAuthLogout(),b.loginRequired&&b.login())};b.callback_id=0;var G=function(){function a(){for(var a=(new Date).getTime(),b=0;b<localStorage.length;b++){var d=localStorage.key(b);if(d&&0==d.indexOf("kc-callback-")){var f=
localStorage.getItem(d);if(f)try{var g=JSON.parse(f).expires;(!g||g<a)&&localStorage.removeItem(d)}catch(q){localStorage.removeItem(d)}}}}if(!(this instanceof G))return new G;localStorage.setItem("kc-test","test");localStorage.removeItem("kc-test");this.get=function(b){if(b){b="kc-callback-"+b;var c=localStorage.getItem(b);c&&(localStorage.removeItem(b),c=JSON.parse(c));a();return c}};this.add=function(b){a();var c="kc-callback-"+b.state;b.expires=(new Date).getTime()+36E5;localStorage.setItem(c,
JSON.stringify(b))}},H=function(){if(!(this instanceof H))return new H;this.get=function(c){if(c){var d;a:{d="kc-callback-"+c+"\x3d";for(var e=document.cookie.split(";"),g=0;g<e.length;g++){for(var h=e[g];" "==h.charAt(0);)h=h.substring(1);if(0==h.indexOf(d)){d=h.substring(d.length,h.length);break a}}d=""}b("kc-callback-"+c,"",a(-100));if(d)return JSON.parse(d)}};this.add=function(c){b("kc-callback-"+c.state,JSON.stringify(c),a(60))};this.removeItem=function(c){b(c,"",a(-100))};var a=function(a){var b=
new Date;b.setTime(b.getTime()+6E4*a);return b},b=function(a,b,c){a=a+"\x3d"+b+"; expires\x3d"+c.toUTCString()+"; ";document.cookie=a}}};"object"===typeof module&&module&&"object"===typeof module.exports?module.exports=x:(k.Keycloak=x,"function"===typeof define&&define.amd&&define("keycloak",[],function(){return x}))})(window);
